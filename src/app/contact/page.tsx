...
export const metadata: Metadata = {
    title: 'Contact Us - NCPL',
    description: 'Get in touch with Nandpur Constructions Private Limited for your infrastructure project requirements. We\'re here to help.',
};

const contactInfo = [
    {
        title: 'Head Office',
        details: ['#1440/147, BBC Bricks, Nandpur', 'Nardiganj, Nawada', 'Bihar - 805109'],
        icon: (
    ...
    {
        title: 'Phone',
        details: ['+91 94319 49247', 'Contact: Sh. Abhinay (Director)'],
        icon: (
            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="relative h-96 bg-gradient-to-br from-gray-200 to-gray-300 rounded-2xl overflow-hidden">
                    <div className="absolute inset-0 flex items-center justify-center">
                        <div className="text-center">
                            ...
                            <p className="text-sm text-gray-400">Nandpur, Nardiganj, Nawada, Bihar</p>
                            <p className="text-xs text-gray-400 mt-2">GSTIN: 10AAKCN2134K1ZQ</p>
                        </div>
                    </div>
                </div>
            </Section>
